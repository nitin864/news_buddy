...
export class News extends Component {
  ...
  let url = "https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=86bff55359fa47a5a3009a639b413675";
  ...
  handlePrevClick= async  ()=>{
       ...
       let url = `https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=86bff55359fa47a5a3009a639b413675&page=${this.state.page - 1}`;
       let data = await fetch(url);
       let pasedData = await data.json()
  ...
  render() {
    ...
    return (
      <div className="container my-3">
        <h3>News Buddy - Top Headlines</h3>
            ...
            return (
              <div className="col-md-4" key={element.url}>
                <NewsItems
                  ...
                  publiahedAt={element.publiahedAt}
                  newsUrl={element.url}
